...
var _runFrame = Module['_runFrame'] = makeInvalidEarlyAccess('_runFrame');
var _getVideoBuffer = Module['_getVideoBuffer'] = makeInvalidEarlyAccess('_getVideoBuffer');
var _loadROM = Module['_loadROM'] = makeInvalidEarlyAccess('_loadROM');
var _setKey = Module['_setKey'] = makeInvalidEarlyAccess('_setKey');
...
function assignWasmExports(wasmExports) {
  ...
  assert(typeof wasmExports['runFrame'] != 'undefined', 'missing Wasm export: runFrame');
  assert(typeof wasmExports['getVideoBuffer'] != 'undefined', 'missing Wasm export: getVideoBuffer');
  assert(typeof wasmExports['loadROM'] != 'undefined', 'missing Wasm export: loadROM');
  assert(typeof wasmExports['setKey'] != 'undefined', 'missing Wasm export: setKey');
  ...
  _reset = Module['_reset'] = createExportWrapper('reset', wasmExports['reset'], 0);
  _runFrame = Module['_runFrame'] = createExportWrapper('runFrame', wasmExports['runFrame'], 0);
  _getVideoBuffer = Module['_getVideoBuffer'] = createExportWrapper('getVideoBuffer', wasmExports['getVideoBuffer'], 0);
  _loadROM = Module['_loadROM'] = createExportWrapper('loadROM', wasmExports['loadROM'], 2);
  _setKey = Module['_setKey'] = createExportWrapper('setKey', wasmExports['setKey'], 2);
